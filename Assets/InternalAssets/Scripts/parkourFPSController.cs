...
public class parkourFPSController : MonoBehaviour
{
	...
	[SerializeField] private float runningMinSpeed = 10f;
	...
	[SerializeField] float wallrunMaxSpeed = 50f;
	...
	[SerializeField] private float snapCameraSpeed = 3f;
	...
	[SerializeField] private float slidingMinSpeed = 10f;
	// TODO
	...
	[SerializeField] private float attackingImpulse = 50f;
	// TODO
	...
	[SerializeField] public MouseLook mouseLook = null;
	...
	void updateRunning()
	{
		...
		if (inputAttacking)
		{
			...
			Physics.Raycast(controller.transform.position, Vector3.forward, out attackRay, hoomingRange);
			if (attackRay.collider.CompareTag("Enemy"))
			{
				isAttacking = true;
			}
		}
